...
The built mod is written to `build/libs/stacksnotslots-0.5.3.jar`. The project uses official Mojang mappings with Parchment parameter names and ModDevGradle's Minecraft-aware JUnit support.
